...
Dragon_Lair_Library.ReturnData = function()
	if (Dragon_Lair_Library.Data == nil) then
		Dragon_Lair_Library.Data = {
			["TeleportData"] = {
				["InsideDungeon"] = {["InsideMapIndex"] = 208, ["EnterPositions"] = {["x"] = 8437, ["y"] = 10669}},
				["OutsideDungeon"] = {["InsideMapIndex"] = 73, ["EnterPositions"] = {["x"] = 1814, ["y"] = 12206}},
			},
			...
			["ItemRequire"] = {["IsRequire"] = true, ["ItemVnum"] = 176004, ["ItemCount"] = 1},

			["TimeData"] = {
				["TimeToCompleteData"] = {["IsRequire"] = true, ["TimeToComplete"] = time_min_to_sec(20)},
				["TimeToWaitData"] = {["IsRequire"] = true, ["TimeToWait"] = time_min_to_sec(30), ["WaitingString"] = "Dragon_Lair"},
			},

			["Respawn_Metin_Stone_Math_Random"] = 100,
			["Respawn_Metin_Stone_Chance"] = 3,
		};
	end -- if

	return Dragon_Lair_Library.Data;
end -- function

Dragon_Lair_Library.IsInDungeon = function()
...
Dragon_Lair_Library.GetDungeonStage = function()
	local DungeonFlag = d.getf("Dragon_Lair_Stage");

	return DungeonFlag;
end -- function

Dragon_Lair_Library.SetNewDungeonStage = function()
	local DungeonState = Dragon_Lair_Library.GetDungeonStage();

	return (d.setf("Dragon_Lair_Stage", DungeonState + 1));
end -- function

Dragon_Lair_Library.SetWaitTime = function()
	local Data = Dragon_Lair_Library.ReturnData();
...
Dragon_Lair_Library.CheckRequire = function()
	local Data = Dragon_Lair_Library.ReturnData();
...
Dragon_Lair_Library.WarpToDungeon = function()
	local Data = Dragon_Lair_Library.ReturnData();
