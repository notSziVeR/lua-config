Red_Dragon_Fortress_Library = {};

Red_Dragon_Fortress_Library.ReturnData = function()
	if (Red_Dragon_Fortress_Library.Data == nil) then
		Red_Dragon_Fortress_Library.Data = {
			["TeleportData"] = {
				["InsideDungeon"] = {["InsideMapIndex"] = 351, ["EnterPositions"] = {["x"] = 7762, ["y"] = 6739}},
			...
			["TimeData"] = {
				...
				["TimeToWaitData"] = {["IsRequire"] = true, ["TimeToWait"] = time_min_to_sec(90), ["WaitingString"] = "Red_Dragon_Fortress"},
			},

			["1th_teleport_coords"] = {["x"] = 8109, ["y"] = 6867},
		};
	end -- if

	return Red_Dragon_Fortress_Library.Data;
end -- function

Red_Dragon_Fortress_Library.IsInDungeon = function()
...
Red_Dragon_Fortress_Library.GetDungeonStage = function()
	local DungeonFlag = d.getf("Red_Dragon_Fortress_Stage");

	return DungeonFlag;
end -- function

Red_Dragon_Fortress_Library.SetNewDungeonStage = function()
	local DungeonState = Red_Dragon_Fortress_Library.GetDungeonStage();

	return (d.setf("Red_Dragon_Fortress_Stage", DungeonState + 1));
end -- function

Red_Dragon_Fortress_Library.SetWaitTime = function()
	local Data = Red_Dragon_Fortress_Library.ReturnData();
...
Red_Dragon_Fortress_Library.CheckRequire = function()
	local Data = Red_Dragon_Fortress_Library.ReturnData();
...
Red_Dragon_Fortress_Library.WarpToDungeon = function()
	local Data = Red_Dragon_Fortress_Library.ReturnData();
