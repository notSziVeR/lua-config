Ship_Defense_Library = {};

Ship_Defense_Library.ReturnData = function()
	if (Ship_Defense_Library.Data == nil) then
		Ship_Defense_Library.Data = {
			["TeleportData"] = {
			...
			["LevelRequire"] = {["IsRequire"] = true, ["MinimumLevel"] = 110, ["MaximumLevel"] = 115},
			...
			["TimeData"] = {
				...
				["TimeToWaitData"] = {["IsRequire"] = true, ["TimeToWait"] = time_min_to_sec(180), ["WaitingString"] = "Ship_Defense"},
			},
		};
	end -- if

	return Ship_Defense_Library.Data;
end -- function

Ship_Defense_Library.IsInDungeon = function()
...
Ship_Defense_Library.SetWaitTime = function()
	local Data = Ship_Defense_Library.ReturnData();
...
Ship_Defense_Library.CheckRequire = function()
	local Data = Ship_Defense_Library.ReturnData();
...
Ship_Defense_Library.WarpToDungeon = function()
	local Data = Ship_Defense_Library.ReturnData();
	...
	if (Data["GroupRequire"]["IsRequire"] and party.is_party()) then
		...
		return sdd.join(EnterData["InsideMapIndex"]);
	end -- if
