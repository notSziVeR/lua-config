...
function text_left()
	raw_script("[TEXT_HORIZONTAL_ALIGN_LEFT]")
end -- function
...
function text_right()
	raw_script("[TEXT_HORIZONTAL_ALIGN_RIGTH]")
end -- function

function say_sash(name)
	say(color256(255, 109, 102) .. name .. color256(196, 196, 196))
end -- function

function say_kill(name)
	say(color256(255, 109, 102) .. name .. color256(196, 196, 196))
end -- function

function say_location(name)
	say(color256(255, 215, 0) .. name .. color256(196, 196, 196))
end -- function

function say_oldwoman(name)
	say(color256(255, 204, 153) .. name .. color256(196, 196, 196))
end -- function
...
function say_guild_name(name)
	say(color256(147, 246, 0) .. name .. color256(196, 196, 196))
end -- end

dofile(get_locale_base_path() .. "/quest/Xemia/Lua_Library/GFquestlib.lua")

dofile(get_locale_base_path() .. "/quest/Xemia/Lua_Library/Battle_Pass.lua")
dofile(get_locale_base_path() .. "/quest/Xemia/Lua_Library/Legendary_Stones.lua")

dofile(get_locale_base_path() .. "/quest/Xemia/Dungeons/Lua_Library/Dungeon_Function.lua")
dofile(get_locale_base_path() .. "/quest/Xemia/Dungeons/Lua_Library/Dungeon_Information.lua")
dofile(get_locale_base_path() .. "/quest/Xemia/Dungeons/Lua_Library/Dungeon_Task_Helper.lua")

dofile(get_locale_base_path() .. "/quest/Xemia/Dungeons/Orc_Maze/Orc_Maze_Library.lua")
dofile(get_locale_base_path() .. "/quest/Xemia/Dungeons/Demon_Tower/Demon_Tower_Library.lua")
dofile(get_locale_base_path() .. "/quest/Xemia/Dungeons/Spider_Queens_Nest/Spider_Queens_Nest_Library.lua")
dofile(get_locale_base_path() .. "/quest/Xemia/Dungeons/Devils_Catacomb/Devils_Catacomb_Library.lua")
dofile(get_locale_base_path() .. "/quest/Xemia/Dungeons/Dragon_Lair/Dragon_Lair_Library.lua")
dofile(get_locale_base_path() .. "/quest/Xemia/Dungeons/Red_Dragon_Fortress/Red_Dragon_Fortress_Library.lua")
dofile(get_locale_base_path() .. "/quest/Xemia/Dungeons/Nemeres_Watchtower/Nemeres_Watchtower_Library.lua")
dofile(get_locale_base_path() .. "/quest/Xemia/Dungeons/Erebos/Erebos_Library.lua")
dofile(get_locale_base_path() .. "/quest/Xemia/Dungeons/Ship_Defense/Ship_Defense_Library.lua")
dofile(get_locale_base_path() .. "/quest/Xemia/Dungeons/Meleys_Hort/Meleys_Hort_Library.lua")

Player_Skill_Data = {
	{ -- */* Warrior *\* --
		{
			["Skill_Vnums"] = {1, 2, 3, 4, 5, 6},
			["Skill_Names"] = {"Trzystronne Ci�cie", "Wir Miecza", "Berserk", "Aura Miecza", "Szar�a", "xXx"}
		},
		{
			["Skill_Vnums"] = {16, 17, 18, 19, 20, 21},
			["Skill_Names"] = {"Duchowe Uderzenie", "Walni�cie", "T�pni�cie", "Silne Cia�o", "Uderzenie Miecza", "xXx"}
		},
	},
	{ -- */* Ninja *\* --
		{
			["Skill_Vnums"] = {31, 32, 33, 34, 35, 36},
			["Skill_Names"] = {"Zasadzka", "Szybki Atak", "Wiruj�cy Sztylet", "Krycie Si� ", "Truj�ca Chmura", "xXx"}
		},
		{
			["Skill_Vnums"] = {46, 47, 48, 49, 50, 51},
			["Skill_Names"] = {"Powtarzalny Strza� ", "Deszcz Strza� ", "Ognista Strza�a", "Bezszelestny Ch�d", "Truj�ca Strza�a", "xXx"}
		},
	},
	{ -- */* Sura *\* --
		{
			["Skill_Vnums"] = {61, 62, 63, 64, 65, 66},
			["Skill_Names"] = {"Uderzenie Palcem", "Smoczy Wir", "Czarowane Ostrze", "Strach", "Czarowana Zbroja", "Rozproszenie Magii"}
		},
		{
			["Skill_Vnums"] = {76, 77, 78, 79, 80, 81},
			["Skill_Names"] = {"Mroczne Uderzenie", "Ogniste Uderzenie", "Ognisty Duch", "Mroczna Ochrona", "Duchowy Cios", "Mroczna Sfera"}
		},
	},
	{ -- */* Shaman *\* --
		{
			["Skill_Vnums"] = {91, 92, 93, 94, 95, 96},
			["Skill_Names"] = {"Lataj�cy Talizman", "Strzelaj�cy Smok", "Smoczy Skowyt", "B�ogos�awie�stwo", "Odbicie", "Pomoc Smoka"}
		},
		{
			["Skill_Vnums"] = {106, 107, 108, 109, 110, 111},
			["Skill_Names"] = {"Rzut Piorunem", "Przywo�anie B�yskawicy", "Burzowy Szpon", "Leczenie", "Zwinno��", "Atak+"}
		},
	}
}
